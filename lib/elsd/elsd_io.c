...
{
    image_double image= read_pgm_image_double(argv[1]);
    double ang_th=atof(argv[2]);
    double density_th=atof(argv[3]);
    double eps = atof(argv[4]);
    int smooth = atoi(argv[5]);
